# How to setup slowfast

## Config:
change from pytorchvideo to:   DTAT.DECODING_BACKEND: pyav

## Decoder
Change decoder.py to (Code appended at last):

Following: https://github.com/facebookresearch/SlowFast/pull/541:

* https://github.com/facebookresearch/SlowFast/blob/e0d247a01c4fa68ad862119379b6dee268a2509e/slowfast/datasets/decoder.py

or 

* https://github.com/xiaojieli0903/FGKVMemPred_video/blob/main/slowfast/datasets/decoder.py


## Install dependencies
```
conda create -n slowfast_py38 python=3.8 -y
conda activate slowfast_py38
```
...
pip install torch==1.8.0 torchvision==0.9.0 torchaudio==0.8.0 --index-url https://download.pytorch.org/whl/cu102
pip install torch==1.10.0 torchvision==0.11.0 torchaudio==0.10.0 --index-url https://download.pytorch.org/whl/cu113 # (includes deprecation warnings)
```
...
# Install FairScale:
pip install 'git+https://github.com/facebookresearch/fairscale.git'
pip install git+https://github.com/facebookresearch/fairscale.git@v0.4.1 # to enable AMP at lower pytorch version
...
```
pip install numpy pandas scikit-learn simplejson psutil termcolor tensorboard opencv-python tqdm moviepy matplotlib
...
<details>
  <summary>Decoder.py updates for pyav</summary>
## Decoder.py updates for pyav
https://github.com/facebookresearch/SlowFast/blob/e0d247a01c4fa68ad862119379b6dee268a2509e/slowfast/datasets/decoder.py
